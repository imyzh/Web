set -gx CONDA_EXE "/opt/Web/Conda/bin/conda"
set _CONDA_ROOT "/opt/Web/Conda"
set _CONDA_EXE "/opt/Web/Conda/bin/conda"
set -gx CONDA_PYTHON_EXE "/opt/Web/Conda/bin/python"
