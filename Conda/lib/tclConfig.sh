...
# installed.
TCL_PREFIX='/opt/Web/Conda'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/opt/Web/Conda'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /opt/Web/Conda/include -fdebug-prefix-map=/tmp/build/80754af9/tk_1592503156360/work=/usr/local/src/conda/tk-8.6.10 -fdebug-prefix-map=/opt/Web/Conda=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /opt/Web/Conda/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/opt/Web/Conda/lib -Wl,-rpath-link,/opt/Web/Conda/lib -L/opt/Web/Conda/lib -Wl,--export-dynamic '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/opt/Web/Conda/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/opt/Web/Conda/include'
...
TCL_PACKAGE_PATH='/opt/Web/Conda/lib '
