...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/opt/Web/Conda/bin',
 'BINLIBDEST': '/opt/Web/Conda/lib/python3.8',
 'BLDLIBRARY': '-L. -lpython3.8',
 'BLDSHARED': 'gcc -pthread -shared -B /opt/Web/Conda/compiler_compat '
              '-L/opt/Web/Conda/lib '
              '-Wl,-rpath=/opt/Web/Conda/lib -Wl,--no-as-needed '
              '-Wl,--sysroot=/',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'x86_64-pc-linux-gnu',
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc -pthread -B /opt/Web/Conda/compiler_compat -Wl,--sysroot=/',
 'CCSHARED': '-fPIC',
 ...
 'CONFIGURE_CPPFLAGS': '-I/opt/Web/Conda/include',
 'CONFIGURE_LDFLAGS': '-L/opt/Web/Conda/lib '
                      '-Wl,-rpath=/opt/Web/Conda/lib -Wl,--no-as-needed '
                      '-Wl,--sysroot=/',
 'CONFIG_ARGS': "'--enable-shared' '--enable-ipv6' '--with-ensurepip=no' "
                "'--prefix=/opt/Web/Conda' "
                "'--with-tcltk-includes=-I/opt/Web/Conda/include' "
                "'--with-tcltk-libs=-L/opt/Web/Conda/lib "
                "-ltcl8.6 -ltk8.6' "
                "'CPPFLAGS=-I/opt/Web/Conda/include' "
                "'LDFLAGS=-L/opt/Web/Conda/lib "
                "-Wl,-rpath=/opt/Web/Conda/lib -Wl,--no-as-needed -Wl,--sysroot=/' "
                "'PKG_CONFIG_PATH=/opt/Web/Conda/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/opt/Web/Conda/include',
 'CONFINCLUDEPY': '/opt/Web/Conda/include/python3.8',
 'COREPYTHONPATH': ':',
 'COVERAGE_INFO': '/opt/Web/Conda/../work/Python-3.8.5/coverage.info',
 'COVERAGE_REPORT': '/opt/Web/Conda/../work/Python-3.8.5/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include '
             '-I/opt/Web/Conda/include',
 'CXX': 'g++ -pthread -B /opt/Web/Conda/compiler_compat -Wl,--sysroot=/',
 'DESTDIRS': '/opt/Web/Conda '
             '/opt/Web/Conda/lib '
             '/opt/Web/Conda/lib/python3.8 '
             '/opt/Web/Conda/lib/python3.8/lib-dynload',
 'DESTLIB': '/opt/Web/Conda/lib/python3.8',
 'DESTPATH': '',
 'DESTSHARED': '/opt/Web/Conda/lib/python3.8/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/opt/Web/Conda/include '
                   '/opt/Web/Conda/include '
                   '/opt/Web/Conda/include/python3.8 '
                   '/opt/Web/Conda/include/python3.8',
 'INCLUDEDIR': '/opt/Web/Conda/include',
 'INCLUDEPY': '/opt/Web/Conda/include/python3.8',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'g++ -pthread -shared -B /opt/Web/Conda/compiler_compat '
                '-L/opt/Web/Conda/lib '
                '-Wl,-rpath=/opt/Web/Conda/lib -Wl,--no-as-needed '
                '-Wl,--sysroot=/',
 'LDFLAGS': '-L/opt/Web/Conda/lib '
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -B /opt/Web/Conda/compiler_compat '
             '-L/opt/Web/Conda/lib '
             '-Wl,-rpath=/opt/Web/Conda/lib -Wl,--no-as-needed '
             '-Wl,--sysroot=/',
 'LDVERSION': '3.8',
 'LIBC': '',
 'LIBDEST': '/opt/Web/Conda/lib/python3.8',
 'LIBDIR': '/opt/Web/Conda/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/opt/Web/Conda/lib/pkgconfig',
 'LIBPL': '/opt/Web/Conda/lib/python3.8/config-3.8-x86_64-linux-gnu',
 'LIBRARY': 'libpython3.8.a',
 'LIBRARY_OBJS': '\\',
 'LIBRARY_OBJS_OMIT_FROZEN': '\\',
 'LIBS': '-lpthread -ldl -lutil -lrt',
 'LIBSUBDIRS': 'tkinter tkinter/test tkinter/test/test_tkinter \\',
 'LINKCC': 'gcc -pthread -B /opt/Web/Conda/compiler_compat -Wl,--sysroot/',
 ...
 'MACHDEPPATH': ':',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/opt/Web/Conda/lib/python3.8',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread -B /opt/Web/Conda/compiler_compat -Wl,--sysroot=/',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/opt/Web/Conda/share/man',
 'MKDIR_P': '/bin/mkdir -p',
 'MODLIBS': '',
 ...
 'PY_CPPFLAGS': '-I. -I./Include '
                '-I/opt/Web/Conda/include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/opt/Web/Conda/lib '
               '-Wl,-rpath=/opt/Web/Conda/lib -Wl,--no-as-needed '
               '-Wl,--sysroot=/',
 'Py_DEBUG': 0,
 'Py_ENABLE_SHARED': 0,
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/opt/Web/Conda/../work/Python-3.8.5',
 'SCRIPTDIR': '/opt/Web/Conda/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TCLTK_INCLUDES': '-I/opt/Web/Conda/include',
 'TCLTK_LIBS': '-L/opt/Web/Conda/lib '
               '-ltcl8.6 -ltk8.6',
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/opt/Web/Conda/../work/Python-3.8.5 '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/opt/Web/Conda/../work/Python-3.8.5 '
 ...
 'abs_builddir': '/opt/Web/Conda/../work/Python-3.8.5',
 'abs_srcdir': '/opt/Web/Conda/../work/Python-3.8.5',
 'datarootdir': '/opt/Web/Conda/share',
 'exec_prefix': '/opt/Web/Conda',
 'prefix': '/opt/Web/Conda',
 'srcdir': '.'}
